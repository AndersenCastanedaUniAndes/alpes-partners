"""
Consumidores simplificados para el módulo de tracking
Versión sin Event Store para pruebas iniciales
"""
import pulsar
import os
...
class ConsumidorComandosSimple:
    def __init__(self):
...
def main():
    consumidor = ConsumidorComandosSimple()
    
    print("🚀 Iniciando consumidores de tracking...")
    print("=" * 50)
